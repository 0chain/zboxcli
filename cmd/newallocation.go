...
var newallocationCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if len(owner) == 0 {
			allocationID, err = storageSdk.CreateAllocation(allocationName, *datashards, *parityshards,
			...
			allocationID, err = storageSdk.CreateAllocationForOwner(allocationName, owner, ownerPublicKey, *datashards, *parityshards,
