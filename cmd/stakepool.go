...
func init() {
	...
	spInfo.PersistentFlags().String("validator_id", "",
		"for given validator")
	spInfo.PersistentFlags().Bool("json (boolean)", false, "pass this option to print response as json data")

	spUserInfo.PersistentFlags().Bool("json (boolean)", false, "pass this option to print response as json data")
	spUserInfo.PersistentFlags().Bool("all (boolean)", false, "pass this option to get all the pools")
