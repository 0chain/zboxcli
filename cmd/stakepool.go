...
func init() {
	...
	spInfo.PersistentFlags().String("validator_id", "",
		"for given validator")
	spInfo.PersistentFlags().Bool("json", false, "<type:bool> pass this option to print response as json data")

	spUserInfo.PersistentFlags().Bool("json", false, "<type:bool> pass this option to print response as json data")
	spUserInfo.PersistentFlags().Bool("all", false, "<type:bool> pass this option to get all the pools")
