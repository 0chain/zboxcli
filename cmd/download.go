...
func init() {
	...
	downloadCmd.Flags().BoolP("thumbnail", "t", false, "<type:bool> pass this option to download only the thumbnail")
	...
	downloadCmd.Flags().BoolP("verifydownload", "v", false, "<type:bool> pass this option to verify downloaded blocks")

	downloadCmd.Flags().Bool("live", false, "<type:bool> start m3u8 downloader,and automatically generate media playlist(m3u8) on --localpath")
