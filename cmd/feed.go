...
var feedCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = startFeedUpload(cmd, allocationObj, localpath, remotepath, encrypt, chunkSize, attrs)
...
func startFeedUpload(cmd *cobra.Command, allocationObj *sdk.Allocation, localPath, remotePath string, encrypt bool, chunkSize int, attrs fileref.Attributes) error {
